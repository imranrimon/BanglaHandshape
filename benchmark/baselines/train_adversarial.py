...
the shared backbone (see `banglahandshape/adversarial.py`), so the backbone is
...
Usage:
    python -m benchmark.baselines.train_adversarial ^
        --config benchmark/configs/bdsl47_si_adv.yaml ^
...
from banglahandshape.class_alignment import discover_source, write_inventory
from banglahandshape.handshape_dataset import enumerate_source, split_user_disjoint
from banglahandshape.adversarial import build_adversarial
