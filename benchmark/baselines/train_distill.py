...
Usage:
    python -m benchmark.baselines.train_distill \
        --config benchmark/configs/bdsl47_si_distill.yaml \
...
from banglahandshape.train_utils import evaluate
...
from benchmark.baselines.train_fusion import _kp_lookup, _norm
