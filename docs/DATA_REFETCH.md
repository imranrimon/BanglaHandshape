...
(`RUNBOOK.md`, Path 3 / `benchmark/`) were removed
...
> Source-of-truth for the paths below: `banglahandshape/class_alignment.py`
> (`DEFAULT_SOURCES`).
...
data is correctly placed and the Path-3 smoke sweep (`RUNBOOK.md`
§5) will run.
