...
On the IDENTICAL split, trains three heads over the same items:
  ...
  * pose       : head on the 63-d MediaPipe hand-keypoint vector (from
                 preprocessing/extract_keypoints.py — signer-agnostic geometry)
...
Usage:
    python -m path3_handshape_benchmark.train_fusion \
        --config path3_handshape_benchmark/configs/fusion_bdsl47_si.yaml --seeds 0 1 2
"""
