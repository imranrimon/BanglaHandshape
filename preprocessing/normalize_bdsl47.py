...
Usage:
  python preprocessing/normalize_bdsl47.py                 # extract .rar + normalise
  python preprocessing/normalize_bdsl47.py --from-extracted data/_bdsl47_tmp
  RAR=data/_downloads/BdSL47.rar DATA_DIR=data python preprocessing/normalize_bdsl47.py
"""
